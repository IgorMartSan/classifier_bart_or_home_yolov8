...
if __name__ == '__main__':
    ...
    model = YOLO('C:\\Users\\igor8\\OneDrive\Área de Trabalho\\classification-yolov8\\yolov8\\yolov8_classifier_homer_bart\\runs\\classify\\train\\weights\\last.pt')  # load a pretrained model (recommended for training)
